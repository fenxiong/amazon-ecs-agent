...
func (m *MockECSSubmitStateSDK) SubmitAttachmentStateChange(arg0 *ecs.SubmitAttachmentStateChangeInput) (*ecs.SubmitAttachmentStateChangeOutput, error) {
	ret := m.ctrl.Call(m, "SubmitAttachmentStateChange", arg0)
	ret0, _ := ret[0].(*ecs.SubmitAttachmentStateChangeOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SubmitAttachmentStateChange indicates an expected call of SubmitAttachmentStateChange
func (mr *MockECSSubmitStateSDKMockRecorder) SubmitAttachmentStateChange(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitAttachmentStateChange", reflect.TypeOf((*MockECSSubmitStateSDK)(nil).SubmitAttachmentStateChange), arg0)
}
