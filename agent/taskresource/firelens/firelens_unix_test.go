...
func TestCreateFirelensResourceFluentdAWSVPCMode(t *testing.T) {
	...
	firelensResource := newMockFirelensResource(FirelensConfigTypeFluentd, awsvcpNetworkMode, testFluentdOptions, mockOS, mockIOUtil)
...
func TestCreateFirelensResourceFluentdBlankMode(t *testing.T) {
	mockOS, mockFile, mockIOUtil, done := setup(t)
	defer done()
