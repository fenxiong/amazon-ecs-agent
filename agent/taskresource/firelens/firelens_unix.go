...
func NewFirelensResource(cluster, taskARN, taskDefinition, ec2InstanceID, dataDir, firelensConfigType, region string,
...
func (firelens *FirelensResource) downloadConfigFromS3() error {
	...
	seelog.Infof("Downloaded firelens config file from s3 and saved to: %s", confFilePath)
	return nil
}
